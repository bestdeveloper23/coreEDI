...
const erpObject = {
    ...
    TStockAdjustEntryList: "TStockAdjustEntryList",
    ...
    TProductBinList: "TProductBinList",
    ...
    TPayRunList: "TPayRunList",
    TPayRunHistory: "TPayRunHistory",
    TProcessStep: "TProcessStep",
    TProcessStepList: "TProcessStepList",
    ...
    TCostReport: "TCostReport",
    TDepot: "TDepot",
    TDepotList: "TDepotList",
    TCostTypesList: "TCostTypesList",
    ...
    TPayPeriod:"TPayPeriod",
    VS1_ClosingDates: "vs1_closingdates",
    VS1AgedReceivableSummary_Card: "VS1AgedReceivableSummary_Card",
    TNewAppointmentsTimeLog: "TNewAppointmentsTimeLog",
    TNewAppointmentTimeSheetEntry: "TNewAppointmentTimeSheetEntry",
    TBankNameList: "TBankNameList",
    TBankCodeList: "TBankCodeList",
    TLeavePayStatus: "TLeavePayStatus",
    TPayrollCalendarsList: "TPayrollCalendarsList",
    TPayrollHolidayGroupList: "TPayrollHolidayGroupList",
    TPayrollHolidaysList: "TPayrollHolidaysList",
    TAllowancesList: "TAllowancesList",
    TDeductionsList: "TDeductionsList",
    TEarningsList: "TEarningsList",
    TPaidLeaveList: "TPaidLeaveList",
    TReimbursementList: "TReimbursementList",
    TSuperAnnuationList: "TSuperAnnuationList",
    TsuperannuationList: "TsuperannuationList",
    TPayrollSettingOvertimesList: "TPayrollSettingOvertimesList",
    TRateTypesList: "TRateTypesList",
    TPayRateTypeList: "TPayRateTypeList",
    TSuperTypeList: "TSuperTypeList",
    TOverTimeEarningsList: "TOverTimeEarningsList",
    TLeavRequestList: "TLeavRequestList",
    TAssignLeaveTypeList: "TAssignLeaveTypeList",
    TPaySlipsList: "TPaySlipsList",
    TDeliverySetting: "TDeliverySetting",
    TDeliveryVehicle: "TDeliveryVehicle",
    TPayNotesList: "TPayNotesList",
    TDeliveryHoursAndCommissions: "TDeliveryHoursAndCommissions",
    TDeliveryBreaks: "TDeliveryBreaks",
    TDeliveryPaymentTypes: "TDeliveryPaymentTypes",
    TDeliveryVehicleFeatures: "TDeliveryVehicleFeatures",
    TDeliverySettingNotification: "TDeliverySettingNotification",
    TVATReturnsList: "TVATReturnsList",
    TDefaultBookingTime: "TDefaultBookingTime",
    TManifest2: "TManifest2",
    TCorrespondenceTemplate: "TCorrespondenceTemplate",
    Vs1_Dashboard: "Vs1_Dashboard",
    TCurrencyRateHistoryList: "TCurrencyRateHistoryList",
    TTransactionDescription: "TTransactionDescription",
    TTransactionDescriptionList: "TTransactionDescriptionList",
    TRouteList: "TRouteList",
    ...
    Tdeliverychart: "Tdeliverychart",
    TEmployeeSkills:"TEmployeeSkills",
    TVS1ProcessClock: "TVS1ProcessClock",
    TVS1EmployeeClockStatus: "TVS1EmployeeClockStatus",
    TProductionPlanData : "TProductionPlanData" ,
    TProductionPartsStatus : "TProductionPartsStatus",
    TTimeSheetList : "TTimeSheetList",
    TFixedAssetSize : "TFixedAssetSize",
    TFixedAssetSizeList : "TFixedAssetSizeList",
    TFixedAssetManufacture : "TFixedAssetManufacture",
    TFixedAssetManufactureList : "TFixedAssetManufactureList",
    TFixedAssetShape : "TFixedAssetShape",
    TFixedAssetShapeList : "TFixedAssetShapeList",
    TFixedAssetWarrantyType : "TFixedAssetWarrantyType",
    TFixedAssetWarrantyTypeList : "TFixedAssetWarrantyTypeList",
    TFixedAssetCondition : "TFixedAssetCondition",
    TAuditList: "TAuditList",
    TMemTransList: "TMemTransList",
};
