...
var erpConnection = {
    ...
    ERPToDoObject: "TToDo?PropertyList=ID,GlobalRef,CreatedDate,CreateedByEmployeeName,Description,ToDoByDate,ToDoType,Result,EmployeeName,EmployeeID&select=[EmployeeName]=" + "'" + localStorage.getItem('mySessionEmployee') + "'",
    ...
    ERPEmpProfileSetting: "TEmployee?PropertyList=ID,GlobalRef,Country,EmployeeName,Email,FirstName,LastName,Notes,Position,Mobile,Active&select=[EmployeeName]=" + "'" + localStorage.getItem('mySessionEmployee') + "'",
    ERPEmpID: "TEmployee?PropertyList=ID,EmployeeName&select=[EmployeeName]=" + "'" + localStorage.getItem('mySessionEmployee') + "'",
    ERPEmpFormAccessDetail: "TEmployeeFormAccessDetail?ListType=Detail&Select=[TabGroup]=26 and [EmployeeId]=" + "'" + localStorage.getItem('mySessionEmployeeLoggedID') + "'",
    getEmpFormAccessDetail: "TEmployeeFormAccessDetail",
    ERPEmpProfilePicture: "TEmployeeAttachment?PropertyList=ID,Attachment,AttachmentName,EmployeeName &select=[EmployeeName]=" + "'" + localStorage.getItem('mySessionEmployee') + "'",
    ERPOrganisationSetting: "TCompanyInfo?PropertyList=ID,GlobalRef,CompanyName,TradingName,CompanyCategory,CompanyNumber,SiteCode,Firstname,LastName,PoBox,PoBox2,PoBox3,PoCity,PoState,PoPostcode,PoCountry,Contact,Address,Address2,Address3,City,State,Postcode,Country,PhoneNumber,Email,Url,MobileNumber,FaxNumber,DvaABN,,ContactEmail,ContactName,abn,Apcano,Bsb,AccountNo,BankBranch,BankCode,Bsb,FileReference,TrackEmails,IsUSRegionTax",
    ERPUSRegionTaxSetting: "TCompanyInfo?PropertyList=ID,Country,IsUSRegionTax",
